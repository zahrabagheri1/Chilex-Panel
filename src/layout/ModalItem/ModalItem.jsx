...
function ModalItem(props) {
  ...
  const handlerSubmit = () => (
    axios.post(`${API_URL === undefined ? '' : API_URL}/games/setting`, addSetting,
      {
        headers: {
  ...
  return (
    <div className='ModalItem'>
      ...
      <div className='mainSetting'>
        <div className='titleModalItem'>Add New Setting</div>
        <div className='row'>
          <div className="ModalItem col-xl-2 col-lg-4 col-md-4 col-sm-6 col-xs-12">
            <div className='ModalItemTitle' >Game</div>
            <div className='ModalItemText' >{props.gameName}</div>
          </div>
