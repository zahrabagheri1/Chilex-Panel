...
function Index() {
    ...
    const [yatzyListChart, setYatzyListChart] = useState()
    ...
    const getyatzyChart = () => {
        setLoading(true)
        axios.get(`${API_URL === undefined ? '' : API_URL}/admin/charts/yatzy?${filters.startDate === null || filters.startDate === undefined ? '' : ('startDate=' + filters.startDate + '&')}${filters.endDate === null || filters.endDate === undefined ? '' : ('endDate=' + filters.endDate + '&')}${filters.type === null || filters.type === undefined ? '' : ('type=' + filters.type)}`,
            {
                headers: {
                ...
                res => {
                    setYatzyListChart(res.data.data)
                    setLoading(false)
                }
            ).catch(
                err => {
